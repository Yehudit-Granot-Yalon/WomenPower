...
public class CircleActivity extends AppCompatActivity {//Tracking a woman's progress
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        showDayDO=(TextView) findViewById(R.id.day_do_status);
                new Thread(new Runnable() {//A function that shows the progress of the gymnastics slowly
                    public void run() {
                        int numDay=1;
                        String findInDB = "";
                        String dayInDB="";
